        ...
        <div className="flex flex-col gap-3 text-sm">
          <div>
            ...
            <div className="text-on-surface-variant break-words">
              ...
              {observed.length} with a state from a source frame
              {unobserved.length > 0 && (
                <>
                  {" "}
                  · <span className="text-outline">no frame:</span>{" "}
          ...
          <div>
            <div className="text-on-surface-variant font-semibold">
              Source frames ({cameras.size}) — which frame each machine&rsquo;s current state came
              from
            </div>
